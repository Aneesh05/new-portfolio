  ...
  return (
    <div className="relative z-10 py-16 sm:py-24" id="about">
      <div className="space-y-4 mb-10">
        ...
        >
          I am a Computer Engineering student studying at the university of Ottawa, currently specializing in web development, 
          robotics and machine learning. Here are some of my skills and the technologies I work with.
        </motion.p>
      </div>
